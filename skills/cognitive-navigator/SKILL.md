...
description: "Use when the user says they cannot follow what is happening, that you are being too technical, that they are getting lost, that they do not want to be a spectator receiving finished work they can no longer evaluate — or at the start of multi-step architecture, refactoring, integration or debugging work. Sets the way of working for the rest of the session: every substantial response opens with a visual map of where things stand, code is preceded by a plain-language version of what it does, and decisions are presented with the alternative rejected plus what would prove them wrong, so the user can still change direction. For a one-off snapshot mid-session, use cognitive-checkpoint instead — it is far cheaper and this file never needs re-invoking. Trigger phrases — I'm lost, I don't follow you, I can't follow this, too technical, explain it simply, explain it like I'm stupid, I don't want to be a spectator, you're going too fast, me pierdo, no te sigo, demasiado técnico, explícamelo para tontos, no quiero ser espectador."
---
